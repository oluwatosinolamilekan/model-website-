            ...
            <div class="grid">
                <div class="unit half">
                    ...
                    <form class="form-box" action="{{route('upload_profile_image')}}" method="post" enctype="multipart/form-data">
                        ...
                        <label>Phone:</label>
                        <input type="number" name="phone" value="{{$user_details->phone ?? ''}}" />

                        <label>Address:</label>
                        <input type="text" name="address" value="{{$user_details->address ?? ''}}" />

                        <label>City:</label>
                        <input type="text" name="city" value="{{$user_details->city ?? ''}}" />

                        <label>State:</label>
                        <input type="text" name="state" value="{{$user_details->state ?? ''}}" />

                        <label>Coutry:</label>
                        <select id="country" name="country" class="form-control">
                            <option value="{{$user_details->country}}">{{$user_details->country}}</option>
                        ...
                        <label>HEIGHT:</label>
                        <input type="number" name="height" value="{{$user_details->height ?? 0}}" />
                        ...
                        <label>WAIST:</label>
                        <input type="number" name="waist" value="{{$user_details->waist ?? 0}}" />
